  ...
  return (
    <div className="w-full space-y-8 lg:space-y-24">
      ...
      <div className="flex flex-col lg:flex-row gap-8 lg:gap-12 items-center justify-center w-full max-w-7xl mx-auto px-4">
        {/* Second Card Stack */}
        <div
          className="relative w-full lg:w-1/2 flex items-center justify-center order-1 lg:order-2 px-2"
        >
          <div className="w-full">
            ...
            >
              <div className="flex items-center mb-3 sm:mb-4">
                <div className="p-2.5 sm:p-3 bg-gradient-to-r from-accent-600 to-accent-500 rounded-xl mr-3 sm:mr-4 shadow-lg">
                  <svg className="w-7 h-7 sm:w-8 sm:h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8c-1.657 0-3 .895-3 2s1.343 2 3 2 3 .895 3 2-1.343 2-3 2m0-8c1.11 0 2.08.402 2.599 1M12 8V7m0 1v8m0 0v1m0-1c-1.11 0-2.08-.402-2.599-1"></path>
                  </svg>
                </div>
                <h3 className="text-lg sm:text-xl lg:text-2xl font-semibold text-white">Retirement Planning</h3>
              </div>
              <p className="text-sm sm:text-sm lg:text-base text-gray-300 leading-relaxed">
            ...
            >
              <div className="flex items-center mb-3 sm:mb-4">
                <div className="p-2.5 sm:p-3 bg-gradient-to-r from-primary-500 to-accent-500 rounded-xl mr-3 sm:mr-4 shadow-lg">
                  <svg className="w-7 h-7 sm:w-8 sm:h-8 text-dark-900" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M9 12l2 2 4-4M7.835 4.697a3.42 3.42 0 001.946-.806 3.42 3.42 0 014.438 0 3.42 3.42 0 001.946.806 3.42 3.42 0 013.138 3.138 3.42 3.42 0 00.806 1.946 3.42 3.42 0 010 4.438 3.42 3.42 0 00-.806 1.946 3.42 3.42 0 01-3.138 3.138 3.42 3.42 0 00-1.946.806 3.42 3.42 0 01-4.438 0 3.42 3.42 0 00-1.946-.806 3.42 3.42 0 01-3.138-3.138 3.42 3.42 0 00-.806-1.946 3.42 3.42 0 010-4.438 3.42 3.42 0 00.806-1.946 3.42 3.42 0 013.138-3.138z"></path>
                  </svg>
                </div>
                <h3 className="text-lg sm:text-xl lg:text-2xl font-semibold text-white">Tax Strategies</h3>
              </div>
              <p className="text-sm sm:text-sm lg:text-base text-gray-300 leading-relaxed">
            ...
            >
              <div className="flex items-center mb-3 sm:mb-4">
                <div className="p-2.5 sm:p-3 bg-gradient-to-r from-primary-600 to-accent-600 rounded-xl mr-3 sm:mr-4 shadow-lg">
                  <svg className="w-7 h-7 sm:w-8 sm:h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M19 21V5a2 2 0 00-2-2H7a2 2 0 00-2 2v16m14 0h2m-2 0h-5m-9 0H3m2 0h5M9 7h1m-1 4h1m4-4h1m-1 4h1m-5 10v-5a1 1 0 011-1h2a1 1 0 011 1v5m-4 0h4"></path>
                  </svg>
                </div>
                <h3 className="text-lg sm:text-xl lg:text-2xl font-semibold text-white">Business Succession</h3>
              </div>
              <p className="text-sm sm:text-sm lg:text-base text-gray-300 leading-relaxed">
            ...
            >
              <div className="flex items-center mb-3 sm:mb-4">
                <div className="p-2.5 sm:p-3 bg-gradient-to-r from-green-600 to-green-500 rounded-xl mr-3 sm:mr-4 shadow-lg">
                  <svg className="w-7 h-7 sm:w-8 sm:h-8 text-white" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M3 12l2-2m0 0l7-7 7 7M5 10v10a1 1 0 001 1h3m10-11l2 2m-2-2v10a1 1 0 01-1 1h-3m-6 0a1 1 0 001-1v-4a1 1 0 011-1h2a1 1 0 011 1v4a1 1 0 001 1m-6 0h6"></path>
                  </svg>
                </div>
                <h3 className="text-lg sm:text-xl lg:text-2xl font-semibold text-white">Mortgage Advisory</h3>
              </div>
              <p className="text-sm sm:text-sm lg:text-base text-gray-300 leading-relaxed">
